...
- Las cruces en el fondo reaccionan al movimiento del mouse (se elevan y agrandan)
- Las estrellas titilan y se desplazan con el mouse
...
- Animaciones CSS con @keyframes — sway y transiciones en las estrellas y cruces
- Responsive design con media queries — adaptar layout a distintos viewports
